const zh = {
  ...
  profExprience: [
    ...
    //},
    {
      name: `1. 湖南大学 (HNU)`,
      workplace: `长沙, 中国`,
      topic: `研究课题: 基于手部区域的第一人称动作识别`,
      title:`助理研究员`,
      supervisor: ` 指导教授: 蔡 敏捷 教授 [湖南大学]`
    },
    {
  ...
  scholar1supp:"(中国排名前0.1\%的学生)",
  scholar2:"2. 岭南学术奖学金  [杰出的学术代表]",
  scholar3:"3. 2021年学年度一等奖奖学金   [年级GPA第一名，2021年]",
  scholar4:"4. 高伟光企业奖学金   [杰出的工程代表]",
  scholar5:"5. 2020年学年度一等奖奖学金   [年级GPA第一名，2020年]",
  scholar6:"6. 2019年学年度一等奖奖学金   [年级GPA第一名，2019年]",
  awards: [
    {
      subtitle: "奖励",
      content: [
  ...
  recentlyProjects: [
    {
      name: "EgoV: 一个全新的跨越真实和虚拟的以自我中心视频的数据集",
    ...
    {
      name: "基于自中心视频手部区域的无监督域适应第一人称动作识别",
  ...
  pastProjects: [
    ...
    {
      name: "多模态视频分析与理解",
      author: `<strong>林 涅</strong>, 郭 凡, 王 杰, 丁 烨, 廖 清`,
      match: "哈尔滨工业大学 (HIT) ",
      match2: ``,
      paper:"",
      projectPage:"",
